...
const assetRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$6$2e$5$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(2000).refine((v)=>!v || /^asset:[a-zA-Z0-9_/-]+\.(jpg|jpeg|png|webp|pdf|mp4|webm)$/.test(v) || /^\/demo\/(plan|living|details|housing-floorplan)\.svg$/.test(v), '不支援的檔案位置');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1j_ov-u._.js.map